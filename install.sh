...
download_xui(){
    ...
    if [ $# == 0 ]; then
        ...
        last_version=$1
        url="https://github.com/byfsea/Misaka-XUI/releases/download/${last_version}/x-ui-linux-$(archAffix).tar.gz"
    ...
    wget -N --no-check-certificate https://raw.githubusercontents.com/byfsea/Misaka-XUImain/x-ui.sh -O /usr/bin/x-ui
